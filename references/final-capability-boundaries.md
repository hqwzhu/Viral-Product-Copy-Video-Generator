...
- Run `scripts/product_batch_runner.py` to read multiple product URLs first, then execute one guarded local promotion cycle per ready product using structured snapshots when available.
