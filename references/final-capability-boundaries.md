...
- Generate a publish setup kit from readiness reports, including environment variable names, missing target fields, approval gates, safe rerun/execution commands, and checklists without storing credential values.
