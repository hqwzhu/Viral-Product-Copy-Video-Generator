...
def managed_skill_files(root: Path) -> list[Path]:
    ...
    for controlled_file in [
        ...
        Path("references/hyperframes-professional/index.html"),
        Path("references/hyperframes-professional/style.css"),
        Path("references/hyperframes-professional/composition.js"),
