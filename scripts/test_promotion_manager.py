...
<body>
  <article>
    ...
    def test_self_evolution_managed_files_include_docs_and_browser_extension(self) -> None:
        ...
        self.assertIn("requirements-professional-media.txt", files)
        ...
        self.assertIn("scripts/fixtures/professional_live_capture_plan.json", files)
        self.assertIn("scripts/fixtures/professional_live_content.json", files)
        self.assertIn("tools/hyperframes-runtime/package.json", files)
        self.assertIn("tools/hyperframes-runtime/package-lock.json", files)
