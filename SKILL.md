...
- `browser-extension/popup.html`, `browser-extension/popup.css`, `browser-extension/popup.js`: extension operator UI, multi-command and periodic automation generator, subscription estimate, license and usage reservation hooks, and ENHE website links.
