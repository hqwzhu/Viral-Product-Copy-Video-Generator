...
3. Generated Codex command.
4. Subscription estimate panel.
5. License validation success with sensitive license value hidden.
6. Usage reservation success.
7. Hosted run started with run ID and status URL.
8. Browser extension package report from `scripts/package_browser_extension.py`.

Do not show real license keys, Stripe secret keys, webhook secrets, private customer data, platform cookies, or unpublished customer products in screenshots.
