...
上架步骤见 `docs/zh-CN/extension-store-submission.md`。v0.5.4 为源码/发行候选，尚未提交 Chrome 审核；后续提交前确认 `dist\v0.5.4\browser-extension-package-report.json` 的 `status` 为 `ready`。
