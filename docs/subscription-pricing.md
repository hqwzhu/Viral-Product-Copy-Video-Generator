...
| Real evidence inbox setup | Generate empty evidence templates, manifest, checklist, and import commands | Local file generation plus hosted state if ENHE stores the run | About 0.10 USD |
