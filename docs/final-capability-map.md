...
| Browser extension with subscription and ENHE traffic | `browser-extension/`, `browser-extension/billing-contract.json`, subscription docs, checkout/portal/license UI | Production license API and payment backend |
